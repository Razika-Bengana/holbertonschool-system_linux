...
/**
 * print_header_details_64 - program that prints the ELF header details for 64-bit files
 *
 ...
 * section headers, etc...;
 *
 * @header: a pointer to an Elf64_Ehdr structure containing the ELF header details
 *
 * Return: nothing (void)
 */
 ...
 * section headers, etc...;
 *
 * @header: a pointer to an Elf32_Ehdr structure containing the ELF header details
 *
 * Return: nothing (void)
 */
 ...
 *
 * this function serves as a wrapper for the specific 32-bit and 64-bit ELF header detail printing functions;
 * it takes a generic pointer to an ELF header and a flag indicating whether the ELF file is 64-bit;
 * it then casts the header to the appropriate type and calls the corresponding function to print the details;
 *
 * @header: a generic pointer to an ELF header structure
 * @is_elf64: a flag indicating whether the ELF file is 64-bit (1) or 32-bit (0)
 *
 * Return: nothing (void)
 */

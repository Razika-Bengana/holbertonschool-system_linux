 ...
 *
 * this function takes a 16-bit unsigned integer and returns it with its byte order reversed;
 ...
 *
 * this function takes a 32-bit unsigned integer and returns it with its byte order reversed;
 ...
 *
 * this function takes a 64-bit unsigned integer and returns it with its byte order reversed;
 * it uses bitwise shifts and OR operations to achieve the swap;
 *

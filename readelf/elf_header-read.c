 ...
 *
 * this function reads the ELF header from the file and stores it in the provided
 * header pointer;
 ...
 * @header: a pointer to the memory location where the ELF header will be stored
 * @is_elf64: a flag to indicate if the ELF file is 64-bit (1) or 32-bit (0)
 *
 * Return: nothing (void)
 */

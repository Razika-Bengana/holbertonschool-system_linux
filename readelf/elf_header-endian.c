 ...
 *
 * this function swaps the bytes of the given value in-place, effectively changing its
 * endianness
 *
...
/**
 * system_is_little_endian - program that determines if the system is little-endian
 *
